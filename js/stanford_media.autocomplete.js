...
(function ($, Drupal, _) {
  ...
  function selectHandler(event, ui) {
    ...
    if (ui.item.entity_type_id || ui.item.entity_uuid || ui.item.substitution_id) {
      ...
      $('input[name*="linkit][data-entity-type]"]', $form).val(ui.item.entity_type_id);
      $('input[name*="linkit][data-entity-uuid]"]', $form).val(ui.item.entity_uuid);
      $('input[name*="linkit][data-entity-substitution]"]', $form).val(ui.item.substitution_id);
    }
