...
- Fix fatal error when creating new media items.

11.5.0
--------------------------------------------------------------------------------
_Release Date: 2026-09-24_

- Updated support to entity_usage v5
...
- Only show unstructured field if configured with a field

11.3.2
--------------------------------------------------------------------------------
_Release Date: 2026-08-06_

- Bug fix: Check for media field exists on embeddable media source.
...
- Add granular permission for media standalone urls if enabled
